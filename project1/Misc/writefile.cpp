    ...
    vector<double> variance, vector<double> acceptRatio)
{
    ...
    filename.append(to_string(numDim) + "dims_");
    filename.append(to_string(numPart) + "particles_");
    filename.append(to_string(metroSteps) + "metrosteps_");
    filename.append(to_string(equilSteps) + "equilsteps.csv");
