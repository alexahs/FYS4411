"""
File written by M. Hjorth-Jensen, and taken from
https://github.com/CompPhysics/ComputationalPhysics2/blob/gh-pages/doc/Programs/Resampling/analysis.py

File is modified to work with Python 3.6 or higher and modified to read a
binary file of 64 bit float values.
"""
